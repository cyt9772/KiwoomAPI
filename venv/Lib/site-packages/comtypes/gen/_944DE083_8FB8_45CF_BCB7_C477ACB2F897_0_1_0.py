...
__all__ = [
    ...
    'UIA_ActiveTextPositionChangedEventId', 'UIA_MainLandmarkTypeId',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'IUIAutomationObjectModelPattern',
    'ProviderOptions_HasNativeIAccessible',
    'UIA_InputReachedOtherElementEventId', 'UIA_CulturePropertyId',
    'ProviderOptions_UseComThreading',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_AnnotationDateTimePropertyId', 'HeadingLevel6',
    'NavigateDirection', 'ExpandCollapseState_PartiallyExpanded',
    'IUIAutomationNotCondition', 'ZoomUnit_NoAmount',
    'IUIAutomationElement', 'UIA_ImageControlTypeId',
    'UIA_ExpandCollapsePatternId', 'UIA_WindowPatternId',
    'NotificationKind', 'UIA_IsScrollItemPatternAvailablePropertyId',
    'DockPosition_Top', 'NotificationProcessing_MostRecent',
    'PropertyConditionFlags_IgnoreCase',
    'UIA_IsDockPatternAvailablePropertyId',
    'IUIAutomationScrollPattern', 'NotificationKind_ItemRemoved',
    'SynchronizedInputType', 'UIA_RadioButtonControlTypeId',
    'UIA_TableRowOrColumnMajorPropertyId', 'ExpandCollapseState',
    'UIA_GridItemRowSpanPropertyId',
    'UIA_IndentationTrailingAttributeId',
    'UIA_LineSpacingAttributeId', 'IUIAutomationElement8',
    'UIA_MenuOpenedEventId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'AnnotationType_GrammarError',
    'UIA_IsGridPatternAvailablePropertyId',
    'UIA_IsKeyboardFocusablePropertyId',
    'UIA_AnnotationTypesAttributeId', 'UIA_StylesStyleNamePropertyId',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_ForegroundColorAttributeId',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'IUIAutomationTextRangeArray',
    'UIA_StrikethroughColorAttributeId', 'ZoomUnit',
    'ScrollAmount_LargeDecrement', 'UIA_ClassNamePropertyId',
    'TextUnit_Word', 'UIA_DropTarget_DroppedEventId',
    'UIA_GridPatternId',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_AnnotationTypesPropertyId', 'UIA_GridItemPatternId',
    ...
    'UIA_DockPatternId', 'NotificationKind_ActionAborted',
    'UIA_LandmarkTypePropertyId', 'HeadingLevel5',
    'IUIAutomationScrollItemPattern',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'SupportedTextSelection_Single', 'UIA_TreeItemControlTypeId',
    ...
    'StyleId_Heading1', 'IUIAutomationSelectionPattern2',
    'HeadingLevel4', 'IUIAutomationCacheRequest',
    ...
    'IUIAutomationTextChildPattern', 'TextUnit_Character',
    'IUIAutomationRangeValuePattern', 'UIA_ProgressBarControlTypeId',
    'UIA_TabControlTypeId', 'UIA_CustomControlTypeId',
    'UIA_SummaryChangeId',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'NavigateDirection_Parent', 'IUIAutomationAnnotationPattern',
    'UIA_ButtonControlTypeId', 'SupportedTextSelection_Multiple',
    'UIA_FontSizeAttributeId', 'SynchronizedInputType_KeyDown',
    'UIA_IsPasswordPropertyId',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_MarginBottomAttributeId', 'UIA_CheckBoxControlTypeId',
    'UIA_ToolBarControlTypeId', 'NotificationProcessing_All',
    'UIA_UnderlineColorAttributeId', 'AnnotationType_UnsyncedChange',
    'UIA_TransformCanMovePropertyId', 'UIA_MenuItemControlTypeId',
    'UIA_IsActiveAttributeId', 'UIA_LiveSettingPropertyId',
    'UIA_DragIsGrabbedPropertyId', 'UIA_GridItemColumnPropertyId',
    'UIA_ProviderDescriptionPropertyId',
    'IUIAutomationSelectionItemPattern',
    'UIA_Selection2LastSelectedItemPropertyId',
    'ZoomUnit_LargeDecrement', 'IUIAutomationExpandCollapsePattern',
    'StyleId_Subtitle', 'UIA_NotificationEventId',
    'IUIAutomationElement3', 'IUIAutomationEventHandlerGroup',
    'ScrollAmount_LargeIncrement', 'UIA_FullDescriptionPropertyId',
    'UIA_StylesExtendedPropertiesPropertyId',
    'ScrollAmount_SmallIncrement', 'UIA_GridItemRowPropertyId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'ExpandCollapseState_Collapsed',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_DropTarget_DragEnterEventId', 'UIA_PositionInSetPropertyId',
    'UIA_AccessKeyPropertyId', 'UIA_FlowsFromPropertyId',
    'NavigateDirection_PreviousSibling',
    'UIA_RangeValueMaximumPropertyId', 'IUIAutomationDragPattern',
    'UIA_Invoke_InvokedEventId', 'UIA_DataGridControlTypeId',
    'IUIAutomationGridItemPattern', 'AnnotationType_InsertionChange',
    'PropertyConditionFlags', 'UIA_ValuePatternId',
    'ToggleState_Indeterminate',
    'IUIAutomationFocusChangedEventHandler',
    'OrientationType_Vertical', 'UIA_AnnotationObjectsAttributeId',
    'UIA_LegacyIAccessibleNamePropertyId',
    'UIA_DragDropEffectsPropertyId', 'AnnotationType_Comment',
    'TextUnit_Paragraph', 'UIA_CustomLandmarkTypeId',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'IUIAutomationProxyFactoryEntry',
    'UIA_StrikethroughStyleAttributeId',
    'SynchronizedInputType_RightMouseDown', 'DockPosition_None',
    'UIA_StylesFillPatternStylePropertyId', 'ZoomUnit_LargeIncrement',
    'StyleId_Custom', 'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_TableColumnHeadersPropertyId', 'IUIAutomationElement4',
    'UIA_SeparatorControlTypeId',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_SizeOfSetPropertyId', 'UIA_OutlineThicknessPropertyId',
    'WindowVisualState_Maximized',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_FillTypePropertyId', 'IUIAutomationGridPattern',
    'TreeScope_None', 'IUIAutomationDockPattern',
    'SynchronizedInputType_RightMouseUp',
    'IUIAutomationTogglePattern', 'DockPosition_Left',
    'UIA_MarginTopAttributeId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_FormLandmarkTypeId', 'UIA_MarginTrailingAttributeId',
    'UIA_MenuModeEndEventId', 'UIA_AfterParagraphSpacingAttributeId',
    'UIA_PaneControlTypeId', 'TextUnit',
    'AnnotationType_CircularReferenceError',
    'UIA_AnnotationTargetPropertyId', 'DockPosition',
    'UIA_FillColorPropertyId', 'IRawElementProviderSimple',
    'UIA_StylesFillPatternColorPropertyId',
    'StructureChangeType_ChildRemoved',
    'UIA_WindowIsTopmostPropertyId', 'UIA_InvokePatternId',
    'HeadingLevel3', 'UIA_ScrollVerticallyScrollablePropertyId',
    'WindowInteractionState_Running',
    'UIA_IsValuePatternAvailablePropertyId',
    'UIA_StructureChangedEventId',
    'UIA_SelectionItem_ElementSelectedEventId', 'StyleId_Heading4',
    'RowOrColumnMajor_RowMajor',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_ValueValuePropertyId', 'UIA_ObjectModelPatternId',
    'UIA_HeaderItemControlTypeId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId', 'UiaChangeInfo',
    ...
    'UIA_SelectionSelectionPropertyId', 'UIA_BulletStyleAttributeId',
    'UIA_IsInvokePatternAvailablePropertyId', 'UIA_TogglePatternId',
    'UIA_StylesFillColorPropertyId', 'UIA_TabItemControlTypeId',
    'UIA_VirtualizedItemPatternId', 'IUIAutomationBoolCondition',
    'UIA_HelpTextPropertyId', 'OrientationType_None', 'HeadingLevel8',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'TextEditChangeType_None', 'TextUnit_Document',
    'UIA_GridItemContainingGridPropertyId',
    'IUIAutomationMultipleViewPattern',
    'UIA_IsDataValidForFormPropertyId',
    'SynchronizedInputType_LeftMouseDown',
    'UIA_ControllerForPropertyId', 'IUIAutomationTablePattern',
    'HeadingLevel_None', 'IUIAutomationTextEditPattern',
    'IUIAutomationSelectionPattern', 'StyleId_Heading5',
    'HeadingLevel7', 'UIA_CapStyleAttributeId', 'HeadingLevel9',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'AnnotationType_EditingLockedChange',
    'UIA_IndentationLeadingAttributeId', 'UIA_DragPatternId',
    ...
    'UIA_RangeValueIsReadOnlyPropertyId', 'UIA_DropTargetPatternId',
    'UIA_ValueIsReadOnlyPropertyId', 'AutomationElementMode_None',
    'UIA_IsSuperscriptAttributeId', 'HeadingLevel2',
    'UIA_IndentationFirstLineAttributeId',
    'ProviderOptions_NonClientAreaProvider',
    'UIA_SpreadsheetItemFormulaPropertyId', 'IUIAutomationTextRange3',
    'UIA_TextPatternId', 'IUIAutomationPropertyChangedEventHandler',
    'ProviderOptions', 'IUIAutomationElement9',
    'IUIAutomationElement2', 'IUIAutomationLegacyIAccessiblePattern',
    ...
    'UIA_TextEditPatternId', 'UIA_Transform2ZoomMaximumPropertyId',
    'UIA_RangeValueSmallChangePropertyId',
    'AnnotationType_DeletionChange', 'UIA_AnimationStyleAttributeId',
    'IUIAutomationPropertyCondition', 'UIA_EditControlTypeId',
    'IUIAutomationSpreadsheetItemPattern',
    'UIA_TitleBarControlTypeId', 'UIA_StyleNameAttributeId',
    'UIA_RangeValuePatternId', 'UIA_TextFlowDirectionsAttributeId',
    'UIA_IsContentElementPropertyId',
    'UIA_DockDockPositionPropertyId',
    'UIA_RangeValueLargeChangePropertyId', 'IUIAutomation',
    'TextEditChangeType_AutoComplete', 'UIA_TextChildPatternId',
    'SupportedTextSelection_None',
    'NotificationProcessing_ImportantMostRecent', 'TextUnit_Page',
    'CoalesceEventsOptions_Enabled',
    'StructureChangeType_ChildrenReordered',
    'NotificationProcessing_CurrentThenMostRecent',
    'IUIAutomationProxyFactory', 'UIA_CalendarControlTypeId',
    'UIA_OverlineColorAttributeId', 'IUIAutomationElement7',
    'UIA_IsSubscriptAttributeId', 'AnnotationType_FormulaError',
    'TextPatternRangeEndpoint_End', 'UIA_Text_TextChangedEventId',
    'UIA_CenterPointPropertyId', 'UIA_ClickablePointPropertyId',
    'AnnotationType_Footer', 'UIA_ItemContainerPatternId',
    'ExpandCollapseState_Expanded',
    'UIA_WindowWindowVisualStatePropertyId', 'AnnotationType_Endnote',
    'AnnotationType_Sensitive', 'UIA_TextEdit_TextChangedEventId',
    'IUIAutomationTextRange2', 'IUIAutomationWindowPattern',
    'UIA_IsStylesPatternAvailablePropertyId',
    'RowOrColumnMajor_Indeterminate', 'UIA_MenuBarControlTypeId',
    'UIA_MenuClosedEventId', 'TreeScope_Element',
    'NotificationKind_Other', 'IUIAutomation6', 'ToggleState_Off',
    'ZoomUnit_SmallDecrement', 'AutomationElementMode',
    'UIA_HasKeyboardFocusPropertyId', 'UIA_IsReadOnlyAttributeId',
    ...
    'UIA_LabeledByPropertyId', 'TextEditChangeType',
    'ProviderOptions_OverrideProvider',
    'AnnotationType_AdvancedProofingIssue', 'StyleId_Normal',
    'TreeTraversalOptions_PostOrder', 'ZoomUnit_SmallIncrement',
    'UIA_TransformPatternId', 'UIA_AppBarControlTypeId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'ProviderOptions_ClientSideProvider', 'UIA_ItemTypePropertyId',
    'AnnotationType_MoveChange', 'UIA_AsyncContentLoadedEventId',
    'UIA_Window_WindowOpenedEventId',
    'NotificationKind_ActionCompleted', 'NotificationProcessing',
    'SupportedTextSelection', 'CUIAutomation8',
    'IUIAutomationTextRange',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'TextEditChangeType_CompositionFinalized', 'IUIAutomation5',
    'UIA_IsDialogPropertyId', 'IUIAutomationValuePattern',
    'UIA_OutlineStylesAttributeId',
    'ConnectionRecoveryBehaviorOptions', 'IUIAutomationTextPattern2',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'UIA_TextPattern2Id', 'UIA_StyleIdAttributeId',
    'ScrollAmount_NoAmount', 'StyleId_Heading2',
    'UIA_ScrollItemPatternId', 'UIA_UnderlineStyleAttributeId',
    'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_LegacyIAccessibleRolePropertyId', 'OrientationType',
    'WindowVisualState_Minimized', 'UIA_CaretBidiModeAttributeId',
    'IUIAutomationNotificationEventHandler', 'UIA_StylesPatternId',
    'UIA_IsRequiredForFormPropertyId', 'UIA_StylesShapePropertyId',
    'CoalesceEventsOptions_Disabled', 'UIA_ListControlTypeId',
    'IUIAutomationInvokePattern', 'UIA_AcceleratorKeyPropertyId',
    'IUIAutomationElement5', 'UIA_LevelPropertyId',
    'UIA_SpreadsheetPatternId',
    'WindowInteractionState_BlockedByModalWindow',
    'StyleId_NumberedList', 'UIA_NamePropertyId',
    'UIA_CaretPositionAttributeId', 'StyleId_BulletedList',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_Transform2ZoomMinimumPropertyId', 'UIA_IsHiddenAttributeId',
    'UIA_TreeControlTypeId', 'UIA_Drag_DragStartEventId',
    'UIA_DragGrabbedItemsPropertyId',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'UIA_AnnotationObjectsPropertyId',
    'UIA_GridItemColumnSpanPropertyId', 'TextUnit_Line',
    'UIA_ChangesEventId', 'StyleId_Heading7',
    'UIA_Selection2ItemCountPropertyId', 'UIA_IsOffscreenPropertyId',
    'UIA_GridColumnCountPropertyId', 'AnnotationType_FormatChange',
    'StyleId_Emphasis', 'UIA_IsRangeValuePatternAvailablePropertyId',
    'IUIAutomationTreeWalker',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_SemanticZoomControlTypeId', 'UIA_RuntimeIdPropertyId',
    'UIA_LinkAttributeId', 'AnnotationType_TrackChanges',
    'UIA_SelectionPattern2Id', 'UIA_ToolTipControlTypeId',
    'ScrollAmount_SmallDecrement', 'UIA_StylesStyleIdPropertyId',
    'UIA_SplitButtonControlTypeId',
    'UIA_LegacyIAccessibleStatePropertyId',
    'IUIAutomationSpreadsheetPattern', 'UIA_DescribedByPropertyId',
    'UIA_InputDiscardedEventId', 'UIA_MarginLeadingAttributeId',
    'UIA_IsControlElementPropertyId', 'TreeScope_Ancestors',
    'UIA_WindowCanMaximizePropertyId', 'RowOrColumnMajor_ColumnMajor',
    'TreeScope_Parent', 'WindowInteractionState_NotResponding',
    'ExtendedProperty', 'UIA_FlowsToPropertyId',
    'UIA_BackgroundColorAttributeId', 'TextPatternRangeEndpoint',
    'UIA_RangeValueMinimumPropertyId', 'UIA_TablePatternId',
    'UIA_MenuControlTypeId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_DocumentControlTypeId', 'UIA_ListItemControlTypeId',
    'StyleId_Heading9', 'IAccessible',
    'UIA_TransformCanRotatePropertyId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'AnnotationType_Header', 'TextUnit_Format',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'AnnotationType_SpellingError', 'IUIAutomationStylesPattern',
    'IUIAutomation4', 'StyleId_Quote', 'UIA_ProcessIdPropertyId',
    'OrientationType_Horizontal',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'ProviderOptions_RefuseNonClientSupport',
    'PropertyConditionFlags_MatchSubstring',
    'WindowInteractionState_Closing', 'ScrollAmount',
    'UIA_FontNameAttributeId', 'UIA_DataItemControlTypeId',
    'DockPosition_Right', 'UIA_HeaderControlTypeId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_TableItemPatternId', 'StructureChangeType_ChildAdded',
    'IUIAutomationEventHandler', 'UIA_Selection_InvalidatedEventId',
    'StyleId_Heading3', 'ToggleState_On',
    'UIA_SayAsInterpretAsMetadataId', 'AnnotationType_Footnote',
    'NotificationKind_ItemAdded', 'IUIAutomationElement6',
    'ExpandCollapseState_LeafNode', 'UIA_LayoutInvalidatedEventId',
    'UIA_WindowControlTypeId', 'UIA_ToolTipClosedEventId',
    'NavigateDirection_NextSibling', 'UIA_VisualEffectsPropertyId',
    'UIA_ComboBoxControlTypeId', 'UIA_SelectionPatternId',
    'Assertive', 'UIA_HeadingLevelPropertyId',
    'UIA_SystemAlertEventId', 'IUIAutomationTransformPattern',
    'UIA_ScrollBarControlTypeId', 'UIA_BoundingRectanglePropertyId',
    'UIA_AriaRolePropertyId', 'IUIAutomationElementArray',
    'IUIAutomation3', 'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_ScrollPatternId', 'UIA_OutlineColorPropertyId',
    'ProviderOptions_ServerSideProvider', 'TreeScope_Descendants',
    'DockPosition_Bottom', 'AnnotationType_ConflictingChange',
    'IUIAutomationCustomNavigationPattern', 'DockPosition_Fill',
    'UIA_TextControlTypeId', 'SynchronizedInputType_LeftMouseUp',
    'UIA_Transform2CanZoomPropertyId', 'IUIAutomationTextPattern',
    'StructureChangeType',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'ProviderOptions_UseClientCoordinates', 'IUIAutomation2',
    'UIA_LegacyIAccessiblePatternId', 'TreeTraversalOptions',
    'UIA_RangeValueValuePropertyId', 'AnnotationType_Unknown',
    'StyleId_Title', 'UIA_LocalizedControlTypePropertyId',
    ...
    'TextEditChangeType_Composition', 'TreeScope_Subtree',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_LocalizedLandmarkTypePropertyId',
    'UIA_TransformCanResizePropertyId', 'UIA_AutomationIdPropertyId',
    'WindowInteractionState',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_CultureAttributeId', 'UIA_NavigationLandmarkTypeId',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'PropertyConditionFlags_None',
    'AnnotationType_DataValidationError', 'ToggleState',
    'UIA_DragDropEffectPropertyId',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_Drag_DragCancelEventId', 'UIA_RotationPropertyId',
    'UIA_OrientationPropertyId', 'UIA_ControlTypePropertyId',
    'UIA_InputReachedTargetEventId',
    'UIA_LegacyIAccessibleHelpPropertyId', 'AnnotationType_Author',
    'UIA_WindowCanMinimizePropertyId', 'UIA_AnnotationPatternId',
    'UIA_FrameworkIdPropertyId', 'UIA_ToggleToggleStatePropertyId',
    'HeadingLevel1', 'WindowVisualState_Normal',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'IUIAutomationTransformPattern2',
    'UIA_IsWindowPatternAvailablePropertyId', 'TreeScope',
    'IUIAutomationDropTargetPattern', 'CUIAutomation', 'Off',
    'IUIAutomationTableItemPattern', 'UIA_TransformPattern2Id',
    'Polite', 'UIA_StatusBarControlTypeId',
    'TextEditChangeType_AutoCorrect', 'UIA_IsItalicAttributeId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'UIA_MultipleViewPatternId', 'AutomationElementMode_Full',
    'UIA_TabsAttributeId', 'IUIAutomationCondition',
    'UIA_GroupControlTypeId', 'UIA_Drag_DragCompleteEventId',
    'UIA_SelectionActiveEndAttributeId',
    'UIA_CustomNavigationPatternId', 'UIA_GridRowCountPropertyId',
    'NotificationProcessing_ImportantAll', 'LiveSetting',
    'UIA_SearchLandmarkTypeId',
    'UIA_Text_TextSelectionChangedEventId', 'StyleId_Heading6',
    'UIA_HyperlinkControlTypeId', 'StyleId_Heading8',
    ...
    'IUIAutomationChangesEventHandler', 'SynchronizedInputType_KeyUp',
    'UIA_Transform2ZoomLevelPropertyId', 'UIA_TableControlTypeId',
    'UIA_ThumbControlTypeId',
    'UIA_LegacyIAccessibleSelectionPropertyId', 'RowOrColumnMajor',
    'UIA_SynchronizedInputPatternId', 'UIA_WindowIsModalPropertyId',
    'UIA_SpreadsheetItemPatternId',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'CoalesceEventsOptions', 'AnnotationType_Highlighted',
    'UIA_HorizontalTextAlignmentAttributeId',
    'NavigateDirection_LastChild', 'UIA_OverlineStyleAttributeId',
    'UIA_SliderControlTypeId', 'UIA_FontWeightAttributeId',
    'AnnotationType_Mathematics'
]

_check_version('1.1.14', 1671279620.803495)
